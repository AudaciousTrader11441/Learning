...
The five-discipline stack described in the AI Engineering Disciplines learning materials -- Prompt Craft, Context Engineering, Harness Engineering, Intent Engineering, and Specification Engineering -- provides the conceptual spine. This framework expands that spine into a full competency model with measurable sub-disciplines and weighted priorities.
